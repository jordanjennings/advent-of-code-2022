...
func main() {
	...
	sandCount := dropSand(rockLocations, maxY + 1)
	fmt.Println("Part 1 Answer:", sandCount)
}

func dropSand(rockOrSandLocations map[point]string, abyssStartY int) int {
	start := point{500, 1}
	sandCount := 0
	intoTheUnknown := false
